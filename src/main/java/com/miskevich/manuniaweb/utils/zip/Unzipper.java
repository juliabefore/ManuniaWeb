...
public class Unzipper {
    ...
    private static final String FILE_LOCATION = "src" + File.separator + "main" + File.separator + "webapp" + File.separator;
    ...
    public Unzipper(String zipFileName) {
        ...
        destinationDirectoryForUnzippedFile = new File(FILE_LOCATION + zipFileName.substring(0, zipFileName.length() - extension.length()));
